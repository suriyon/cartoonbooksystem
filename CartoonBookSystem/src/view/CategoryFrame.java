...
public class CategoryFrame extends JInternalFrame {
	...
	public CategoryFrame() {
		setFrameIcon(new ImageIcon(CategoryFrame.class.getResource("/images48/category48.png")));
		...
		textCatId.setEnabled(false);
		textCatId.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textCatId.setBounds(39, 52, 140, 25);
		panel.add(textCatId);
		textCatId.setColumns(10);
		
		textCatName = new JTextField();
		textCatName.setFont(new Font("Tahoma", Font.PLAIN, 14));
		textCatName.setBounds(203, 52, 275, 25);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textCatName.getText().equals("")) {
					JOptionPane.showMessageDialog(null, 
							"Please enter category name!", 
							"Information", 
							JOptionPane.INFORMATION_MESSAGE);
				}else {
					String catId = textCatId.getText().toString();
					...
					if(result) {
						JOptionPane.showMessageDialog(null, 
								"Insert category to table successfully.", 
								"Information", 
								JOptionPane.INFORMATION_MESSAGE);
						addDataToTable();
					}else {
						JOptionPane.showMessageDialog(null, 
								"Error in insert category!!!", 
								"Error", 
		...
		btnAdd.setIcon(new ImageIcon(CategoryFrame.class.getResource("/images32/add32.png")));
		...
		btnClose.setIcon(new ImageIcon(CategoryFrame.class.getResource("/images32/close32.png")));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(textCatName.getText().equals("")) {
					...
					if(result) {
						JOptionPane.showMessageDialog(null, 
								"Update category to table successfully.", 
								"Information", 
								JOptionPane.INFORMATION_MESSAGE);
						addDataToTable();
					}else {
		...
		btnUpdate.setIcon(new ImageIcon(CategoryFrame.class.getResource("/images32/refresh32.png")));
		...
		btnClear.setIcon(new ImageIcon(CategoryFrame.class.getResource("/images32/clear32.png")));
		...
		btnSearch.setIcon(new ImageIcon(CategoryFrame.class.getResource("/images32/search32.png")));
	...
	protected void addDataToTable(String name) {
		...
		CategoryDAO dao = new CategoryDAO();
		Vector categories = dao.selectByName(name);
		
		int size = categories.size();
		for(int i=0; i<size; i++) {
			model.addRow((Vector) categories.get(i));
		}
	}
	...
	private void addDataToTable() {
		...
		CategoryDAO dao = new CategoryDAO();
		Vector categories = dao.selectAll();
	...
	private void prepareTable() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				textCatId.setText(table.getValueAt(row, 0).toString());
				textCatName.setText(table.getValueAt(row, 1).toString());
	...
	private void generateCatId() {
		CategoryDAO dao = new CategoryDAO();
		textCatId.setText(dao.genCatId());
	}
}
